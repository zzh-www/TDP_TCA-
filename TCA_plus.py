...
class TCA_plus:
    ...
    def N3_normalize(Xs, Xt):
        Xs = (Xs - np.mean(Xs, axis=0)) / (np.std(Xs, axis=0)+0.000000000001)
        Xt = (Xt - np.mean(Xs, axis=0)) / (np.std(Xs, axis=0)+0.000000000001)
        return Xs, Xt

    @staticmethod
    def N4_normalize(Xs, Xt):
        Xs = (Xs - np.mean(Xt, axis=0)) / (np.std(Xt, axis=0)+0.000000000001)
        Xt = (Xt - np.mean(Xt, axis=0)) / (np.std(Xt, axis=0)+0.000000000001)
        return Xs, Xt
